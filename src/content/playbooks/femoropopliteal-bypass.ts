...
const blocks: TopicBlock[] = [
  ...
  sourced({
    ...
    steps: [
      { title: "Expose the inflow", detail: "Vertical groin incision over the femoral pulse at the mid-inguinal point. Expose the common, superficial and profunda femoral arteries and encircle them. Control the common femoral artery up to the inguinal ligament and identify the bifurcation. Ligate crossing lymphatics rather than cauterising them, and protect the profunda origin — it is the collateral bed if the graft fails." },
