...
const blocks: TopicBlock[] = [
  ...
  sourced({
    ...
    items: [
      "Trauma: hemodynamic instability with a positive FAST or diagnostic peritoneal lavage, peritonitis, evisceration, free intraperitoneal air, diaphragmatic rupture, or intraperitoneal bladder rupture.",
      "Non-trauma: generalized peritonitis, free perforation, bowel ischemia or gangrene, closed-loop obstruction, and toxic megacolon that fails medical therapy.",
