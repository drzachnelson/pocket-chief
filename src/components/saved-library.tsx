...
export function SavedLibrary() {
  ...
  return <div className="empty-state"><span className="empty-icon"><BookmarkSimple size={23} /></span><h2>No saved topics yet</h2><p>Use the bookmark on any reviewed topic. Saved topics and recent views stay private to this device.</p><Link className="button" href="/"><MagnifyingGlass size={15} />Find a topic</Link></div>;
}
