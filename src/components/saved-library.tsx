...
export function SavedLibrary() {
  ...
  return <div className="empty-state"><span className="empty-icon"><BookmarkSimple size={23} /></span><h2>No saved topics yet</h2><p>Use the bookmark on any reviewed topic. Saved topics sync privately and remain cached on this device.</p><Link className="button" href="/"><MagnifyingGlass size={15} />Find a topic</Link></div>;
}
