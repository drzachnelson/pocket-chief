...
const summaryBlock: TopicBlock = {
    ...
    claims: [cited("claim-summary", "Approach selection is driven by stone burden, location, and duct anatomy.")],
  };
const comparisonBlock: TopicBlock = {
    ...
    claims: [cited("claim-table", "The supplied packet compares transcystic exploration, choledochotomy, and ERCP using burden, location, and anatomy.")],
  };
const flowBlock: TopicBlock = {
    ...
    claims: [cited("claim-flow", "Small distal stones and a favorable cystic duct support the transcystic route; complex burdens support an alternative route.")],
  };
const sequenceBlock: TopicBlock = {
    ...
    claims: [cited("claim-sequence", "The supplied packet describes a six-step transcystic choledochoscopy workflow ending with completion imaging.")],
  };
const warningBlock: TopicBlock = {
    ...
    claims: [cited("claim-warning", "The listed burden and anatomy features are relative contraindications to transcystic exploration in the supplied packet.")],
  };
