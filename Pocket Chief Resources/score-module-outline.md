# SCORE module topic outline

The curriculum outline as supplied by the owner, 2026-08-14. This is the **source of truth for taxonomy placement**: when adding a topic, find it here first and derive `SECTION` / `scoreCategory` from the module and the Diseases/Conditions vs Operations/Procedures split. If a requested topic is not in this list, or its placement is ambiguous, ask rather than inventing a branch.

Section names convert to taxonomy as `SCORE · <Module> · Diseases & Conditions` or `SCORE · <Module> · Operations & Procedures`.

Transcribed verbatim apart from repairing OCR ligatures (`ﬃ`, `ﬀ`). Duplications and typos in the source list are preserved.
...
- Cricopharyngeal Myotomy and Resection of Zenker Diverticulum
- Esophagectomy
...
- GISTs and Miscellaneous Digestive Neoplasms
- Morbid Obesity
...
**Operations/Procedures**
- Access Procedures for Nutritional Support
  - Stamm gastrostomy / gastropexy
- Gastrectomy
- Gastroduodenal Perforation Repair
- Vagotomy and Drainage
- Procedures for Morbid Obesity
- Revisional Procedures after Gastrectomy
...
- Abdominoperineal Resection and Pelvic Exenteration
...
**Diseases/Conditions**
- Atypical Hyperplasia, Flat Epithelial Atypia, and Lobular Carcinoma in Situ of the Breast
- Benign Inflammatory Disease of the Breast
- Breast Disease During Pregnancy and Lactation
- Breast Invasive Carcinoma
- Ductal Carcinoma in Situ
- Fat Necrosis, Fibrocystic Changes, and Radial Scar of the Breast
- Fibroadenoma and Phyllodes Tumors
- Hereditary Breast Cancer
- Inflammatory Breast Cancer
- Initial Management of a Breast Mass
- Male Gynecomastia and Breast Cancer
...
- Radiographic Abnormalities of the Breast

**Operations/Procedures**
- Axillary Procedures in Breast Cancer
- Breast Duct Excision
- Excisional Breast Biopsy and Partial Mastectomy
- Percutaneous Breast Biopsy and Cyst Aspiration
- Simple, Modified Radical, and Radical Mastectomy

## ENDOCRINE

**Diseases/Conditions**
- Hypercortisolism and Cushing Syndrome/Disease
- Hyperparathyroidism
- Hyperthyroidism
...
- Procedures for Soft Tissue Infections
- Sentinel Lymph Node Biopsy for Melanoma
- Surgical Management of Skin/Soft Tissue Lesion
...
- Renal Failure
- Respiratory Failure: ARDS, Pulmonary Embolism, and Pneumonia
- Sepsis and Septic Shock
- Organ Donors and Selection Criteria

**Operations/Procedures**
- Airway Access: Intubation and Surgical Airways
- Ultrasound for Intravascular Access
- Vascular Access
- Cardiac Pacing
...
- Initial Assessment and Management of Neck Trauma
...
- Gastrointestinal Tract Injury Repair
- Hepatic Injury Packing, Repair, and Resection
- Neck Injuries Management
- Splenectomy and Splenorrhaphy
- Procedures for Urinary Tract Injuries
- Procedures for Vascular Injuries
- Wounds Management
- Cardiac Injury Repair
- Hand Tendon Repairs
- Procedures for Esophageal Injury
- Procedures for Thermal Injuries
- Skin Grafting for Thermal Injuries
...
- Aortic Aneurysms
- Arterial Peripheral Aneurysms
- Arterial Visceral Aneurysms
...
**Operations/Procedures**
- Arterial Embolectomy and Thrombectomy
- Lower Extremity Amputations
- Abdominal and Aortoiliac Aneurysm Repair
- Aortoiliac Reconstruction for Occlusive Disease
- Endovascular Intervention Principles
- Extra-anatomic Bypass
- Graft-enteric Fistula Management
- Lower Extremity Bypass
- Peripheral Aneurysms Repair
- Procedures for Carotid Artery Stenosis
- Procedures for Mesenteric Occlusive Disease
- Superior Mesenteric Artery (SMA) Embolectomy and Thrombectomy
- Ultrasound in the Diagnosis and Management of Vascular Diseases

## VASCULAR VENOUS

**Diseases/Conditions**
- Evaluation of a Swollen Leg
- Thrombophlebitis
- Varicose Veins
...
- Venous Insufficiency and Related Procedures
...
**Operations/Procedures**
- Vascular Exposure Principles
- Venous Access Devices Insertion
- Arteriovenous Graft and Fistula
...
- Anorectal Malformations Operation
...
- Hirschsprung Disease Operation
- Intestinal Atresia and Stenosis Repair
...
**Operations/Procedures**
- Surgical Considerations of the Pregnant Patient
- Cesarean Section
